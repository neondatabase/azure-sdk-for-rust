...
#[derive(Debug, Clone)]
pub(crate) struct BlobBatchOperations {
    batch_uuid: Uuid,
    change_set_uuid: Uuid,
    operations: Vec<BlobBatchOperation>,
}

impl BlobBatchOperations {
    ...
    pub(crate) fn add(&mut self, transaction_operation: BlobBatchOperation) -> &mut Self {
        self.operations.push(transaction_operation);
        self
    }
    ...
    pub(crate) fn to_string(&self) -> azure_core::Result<String> {
        ...
        for transaction_operation in &self.operations {
...
#[derive(Debug, Clone)]
pub struct BlobBatchOperation {
    pub(crate) request: Request,
}

impl BlobBatchOperation {
